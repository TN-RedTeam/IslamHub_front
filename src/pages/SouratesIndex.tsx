    ...
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-emerald-50 dark:from-gray-900 dark:to-emerald-950">
      <m.header
        ...
        <div className="relative container mx-auto px-4 max-w-4xl text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white font-amiri">Exégèse du Coran</h1>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {sourates.map((s) => (
              <Link
                ...
                className="group bg-white dark:bg-gray-800 rounded-2xl border border-emerald-100 dark:border-emerald-900 shadow-sm p-5 flex items-center gap-4 hover:shadow-md hover:border-emerald-300 dark:hover:border-emerald-700 transition-all"
              >
                ...
                <span className="flex-1 min-w-0">
                  <span className="block font-bold text-emerald-900 dark:text-emerald-200 font-amiri group-hover:text-emerald-700 dark:group-hover:text-emerald-100">{s.nom}</span>
